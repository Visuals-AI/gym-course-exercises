...
def adjust(obs, action, reward, td: TerminateDetector, step) :
    ...
    gp1 = obs[0][17]               # 机器人感知到前方 7 个连续点的第 1 个的地形高度（y 轴）
    gp2 = obs[0][18]               # 机器人感知到前方 7 个连续点的第 2 个的地形高度（y 轴）
    gp3 = obs[0][19]               # 机器人感知到前方 7 个连续点的第 3 个的地形高度（y 轴）
    gp4 = obs[0][20]               # 机器人感知到前方 7 个连续点的第 4 个的地形高度（y 轴）
    gp5 = obs[0][21]               # 机器人感知到前方 7 个连续点的第 5 个的地形高度（y 轴）
    gp6 = obs[0][22]               # 机器人感知到前方 7 个连续点的第 6 个的地形高度（y 轴）
    gp7 = obs[0][23]               # 机器人感知到前方 7 个连续点的第 7 个的地形高度（y 轴）
